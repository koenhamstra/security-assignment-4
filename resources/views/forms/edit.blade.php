    ...
    <div id="why" class="why">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <form method="POST" class='blog-form' action="/forms/{{$form->id}}">
                            @csrf
                            @method('PUT')
                            {{-- Cross-Site Request Forgery --}}
                            <h1>Name</h1><br>
                            <input class="input-group mb-3 @error('first_name') is-danger @enderror"
                                   type="text"
                                   id="first_name"
                                   name="first_name"
                            ...
                            <h1>Purpose</h1><br>
                            <input class="input-group mb-3 @error('purpose') is-danger @enderror"
                                   type="text"
                                   id="purpose"
                                   name="purpose"
                                   value="{{$form->purpose}}"><br>
                            @error('purpose')
                            <p class="help is-danger">{{$errors->first('purpose')}}</p>
                            @enderror

                            <h1>Date of Birth</h1><br>
                            <input class="input-group mb-3 @error('year_of_birth') is-danger @enderror"
                                   type="date"
                                   id="year_of_birth"
                                   name="year_of_birth"
                                   value="{{$form->year_of_birth}}"><br>
                            @error('year_of_birth')
